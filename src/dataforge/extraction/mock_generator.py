...
NAMES = ["João Silva", "Maria Santos", "Pedro Oliveira", "Ana Costa", "Carlos Souza", "Juliana Lima"]                 
...
def generate_mock_sales_file(filename: str, num_records: int = 50) -> str:                                            
    ...
    for i in range(1, num_records + 1):                                                                               
        row = {                                                                                                       
                ...
                "O. Sem leit real": "N",                                                                                  
                "Nota leit.": "",                                                                                         
                "Hora leit.": (datetime.now() - timedelta(minutes=random.randint(5, 500))).strftime("%H:%M:%S"),          
                "Seq.Mod": 1,                                                                                             
                "Cond WOL": "Normal",                                                                                     
