...
if __name__ == "__main__":
    ...
    print(f'Iniciando os Buckets no MinIO\n')
    init_s3_buckets()

    print(f'Realizando teste para tentar camada bronze via excel... \n')
    ...
    print(f'Realizando teste para tentar camada bronze via api de clientes... \n')
